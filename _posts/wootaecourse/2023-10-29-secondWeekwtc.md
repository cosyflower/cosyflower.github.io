...
1번 고민과도 연관된 2번쨰 고민이다. 생성자를 2개로 구분해서 현재 있는 위치를 지정할 수 있다
...
<u>나의 선택은 Domain 그리고 InputView 각각 검증하는 방향으로 진행하는 것이었다</u>
...
<u>**또한!! test code를 위해서 production code를 추가해서는 안 된다는 엄청난 깨달음을 얻었다**</u>
...
<u>첨언하자면, 테스트를 진행할 때는 애매한 상황, 경계에 놓인 값들을 위주로 작성하는 것은 기본이다. 기본기를 잃지 말자 </u>
...
<u>**"View에서 Model로 데이터를 전달할 때 어떻게 처리할 지를 생각해볼 필요가 있다"**</u>
<br>
